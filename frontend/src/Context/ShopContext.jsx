...
const AppContextProvider=({children})=>{
    ...
    return(
        <AppContext.Provider value={{darkModeValue, darkMode, cartItem, cartArray, findCartLength, removeCartItem, getTheProductArray, getTotalCartItems, storeTokenInLocalStorage, tokenValue, logoutUser, URL, setHiddenNavbar, hiddenNavbar}}>
            {children}
        </AppContext.Provider>
    )
}
