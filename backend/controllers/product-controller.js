...
const getAllProductArray=async(req, res)=>{
    try {
...
const getSingleProductArray=async(req, res)=>{
    try {
...
const getCategoryWiseProductArray=async(req, res)=>{
    try {
...
const getNewCollectionArray=async(req, res)=>{
    try {
...
module.exports = { addProduct, getAllProductArray, getSingleProductArray, getCategoryWiseProductArray, getNewCollectionArray }